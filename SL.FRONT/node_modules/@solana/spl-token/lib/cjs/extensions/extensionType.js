...
const index_js_2 = require("./confidentialTransfer/index.js");
const index_js_3 = require("./defaultAccountState/index.js");
const index_js_4 = require("./tokenGroup/index.js");
...
const index_js_5 = require("./memoTransfer/index.js");
...
const index_js_6 = require("./pausable/index.js");
const permanentDelegate_js_1 = require("./permanentDelegate.js");
const index_js_7 = require("./scaledUiAmount/index.js");
const index_js_8 = require("./transferFee/index.js");
const index_js_9 = require("./transferHook/index.js");
...
function getTypeLen(e) {
    switch (e) {
        ...
        case ExtensionType.TransferFeeConfig:
            return index_js_8.TRANSFER_FEE_CONFIG_SIZE;
        case ExtensionType.TransferFeeAmount:
            return index_js_8.TRANSFER_FEE_AMOUNT_SIZE;
        case ExtensionType.MintCloseAuthority:
            return mintCloseAuthority_js_1.MINT_CLOSE_AUTHORITY_SIZE;
        case ExtensionType.ConfidentialTransferMint:
            return index_js_2.CONFIDENTIAL_TRANSFER_MINT_SIZE;
        case ExtensionType.ConfidentialTransferAccount:
            return index_js_2.CONFIDENTIAL_TRANSFER_ACCOUNT_SIZE;
        case ExtensionType.CpiGuard:
            return index_js_1.CPI_GUARD_SIZE;
        case ExtensionType.DefaultAccountState:
            return index_js_3.DEFAULT_ACCOUNT_STATE_SIZE;
        case ExtensionType.ImmutableOwner:
            return immutableOwner_js_1.IMMUTABLE_OWNER_SIZE;
        case ExtensionType.MemoTransfer:
            return index_js_5.MEMO_TRANSFER_SIZE;
        ...
        case ExtensionType.TransferHook:
            return index_js_9.TRANSFER_HOOK_SIZE;
        case ExtensionType.TransferHookAccount:
            return index_js_9.TRANSFER_HOOK_ACCOUNT_SIZE;
        ...
        case ExtensionType.TokenGroup:
            return index_js_4.TOKEN_GROUP_SIZE;
        case ExtensionType.TokenGroupMember:
            return index_js_4.TOKEN_GROUP_MEMBER_SIZE;
        case ExtensionType.ScaledUiAmountConfig:
            return index_js_7.SCALED_UI_AMOUNT_CONFIG_SIZE;
        case ExtensionType.PausableConfig:
            return index_js_6.PAUSABLE_CONFIG_SIZE;
        case ExtensionType.PausableAccount:
            return index_js_6.PAUSABLE_ACCOUNT_SIZE;
        case ExtensionType.TokenMetadata:
